...
#+BEGIN_SRC emacs-lisp
  ...
  ;; GNU ELPA signature checks can fail on machines without a working GPG setup.
...
(defun abo/log-next-todo-done-to-journal ()
  "When a TODO changes state in `abo/next-todos-file', append it to today's journal."
