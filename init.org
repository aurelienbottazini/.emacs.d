...
(defun abo/org-attach--insert-link-under-heading (basename)
  "Insert an `attachment:' link for BASENAME below the current heading."
  (let* ((description (replace-regexp-in-string
                       "[][]"
                       (lambda (match) (concat "\\" match))
                       basename t t))
         (link (org-link-make-string (concat "attachment:" basename) description)))
    (save-excursion
      (org-back-to-heading t)
...
(defun abo/org-attach-file-from-macos-clipboard ()
  ...
  (save-excursion
    ...
    (let ((path (abo/org-attach--resolve-clipboard-path)))
      ...
      (abo/org-attach--insert-link-under-heading
