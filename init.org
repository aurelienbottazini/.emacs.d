...
I use zenburn version from /doom-themes/ as I like the broad coverage
of uses cases covered by /doom-emacs/.
...
I don't use this with doom-modelines as I find the indicators from
doom-modeline good enough.
#+begin_src emacs-lisp :tangle no
...
/C-x w NUMBER/ to select a window by number. Numbers appear in the modeline.
#+begin_src emacs-lisp
(use-package winum
:config
(winum-mode 1))
