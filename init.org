...
On Ubuntu 20.04 I had to [[https://github.com/aurelienbottazini/dotfiles/blob/565cfb75d84d323e472232698458167ce5a66076/home/.config/shell/exports#L89][add a TERM env variable]]  and add the
corresponding =terminfo= entry
#+begin_src shell
tix -x ~/.emacs.d/terminfo-24bit.src
#+end_src
