...
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit default :extend nil :foreground "#DFAF8F" :slant italic :weight light :height 1.3 :family "Operator Mono"))))
 '(org-level-2 ((t (:inherit default :extend nil :foreground "#bfebbf" :slant italic :weight light :height 1.1 :family "Operator Mono"))))
 '(org-level-3 ((t (:inherit default :extend nil :foreground "#7cb8bb" :slant italic :weight light :family "Operator Mono"))))
 '(org-level-4 ((t (:inherit default :extend nil :foreground "#d0bf8f" :slant italic :weight light :family "Operator Mono"))))
 '(org-level-5 ((t (:inherit default :extend nil :foreground "#93e0e3" :slant italic :weight light :family "Operator Mono"))))
 '(org-level-6 ((t (:inherit default :extend nil :foreground "#9fc59f" :slant italic :weight light :family "Operator Mono"))))
 '(org-level-7 ((t (:inherit default :extend nil :foreground "#8c5353" :slant italic :weight light :family "Operator Mono"))))
 '(org-level-8 ((t (:inherit default :extend nil :foreground "#4c7073" :slant italic :weight light :family "Operator Mono"))))
