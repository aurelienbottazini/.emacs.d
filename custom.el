...
(custom-set-faces
 ...
 '(org-code ((t (:inherit shadow :weight light :width normal))))
 ...
 '(org-level-1 ((t (:inherit default :extend nil :foreground "#DFAF8F" :slant italic))))
 '(org-level-2 ((t (:inherit default :extend nil :foreground "#bfebbf" :slant italic))))
 '(org-level-3 ((t (:inherit default :extend nil :foreground "#7cb8bb" :slant italic))))
 '(org-level-4 ((t (:inherit default :extend nil :foreground "#d0bf8f" :slant italic))))
 '(org-level-5 ((t (:inherit default :extend nil :foreground "#93e0e3" :slant italic))))
