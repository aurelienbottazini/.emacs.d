...
(custom-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "#6f9f7f" :italic t :family "Operator Mono" :height 1.1 :weight light))))
 '(font-lock-string-face ((t (:foreground "#cc9393" :italic t :family "Operator Mono" :height 1.1 :weight light))))
 ...
 '(org-block ((t (:extend t :background "#494949" :family "Input Mono"))))
 '(org-code ((t (:inherit shadow :weight light :width normal :family "Input Mono"))))
 ...
 '(org-level-1 ((t (:inherit default :extend nil :foreground "#DFAF8F" :slant italic :weight normal :height 1.3 :family "Operator Mono"))))
 '(org-level-2 ((t (:inherit default :extend nil :foreground "#bfebbf" :slant italic :weight normal :height 1.1 :family "Operator Mono"))))
 '(org-level-3 ((t (:inherit default :extend nil :foreground "#7cb8bb" :slant italic :weight normal :family "Operator Mono"))))
 '(org-level-4 ((t (:inherit default :extend nil :foreground "#d0bf8f" :slant italic :weight normal :family "Operator Mono"))))
 '(org-level-5 ((t (:inherit default :extend nil :foreground "#93e0e3" :slant italic :weight normal :family "Operator Mono"))))
 '(org-level-6 ((t (:inherit default :extend nil :foreground "#9fc59f" :slant italic :weight normal :family "Operator Mono"))))
 '(org-level-7 ((t (:inherit default :extend nil :foreground "#8c5353" :slant italic :weight normal :family "Operator Mono"))))
 '(org-level-8 ((t (:inherit default :extend nil :foreground "#4c7073" :slant italic :weight normal :family "Operator Mono"))))
 ...
 '(variable-pitch ((t (:family "HeinemannSpecial" :height 1.1))))
