...
(custom-set-faces
 ...
 '(diary ((t (:foreground "#8c5353"))))
 '(diff-hl-delete ((t (:foreground "#cc9393"))))
 ...
 '(error ((t (:foreground "#94BFF3"))))
 '(evil-ex-info ((t (:foreground "#ecb3b3"))))
 '(evil-ex-substitute-replacement ((t (:foreground "#ecb3b3"))))
 '(evil-search-highlight-persist-highlight-face ((t (:background "#f0dfaf" :foreground "black"))))
 '(fill-column-indicator ((t (:foreground "#5f5f5f"))))
 '(gnus-emphasis-highlight-words ((t (:foreground "#f0dfaf" :background "#989890"))))
