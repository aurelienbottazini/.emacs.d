(custom-set-variables
 ...
 '(hywiki-directory "~/Dropbox/notes/zk")
 ...
 '(package-selected-packages
   '(cape copilot corfu deadgrep deft diminish dired-rsync drag-stuff emamux embark-consult envrc
          evil-commentary evil-matchit evil-surround evil-visualstar exec-path-from-shell
          expand-region general gruvbox-theme highlight-blocks hydra hyperbole iedit key-chord magit
          marginalia markdown-mode multiple-cursors ob-clojurescript ob-mermaid orderless
          org-download org-ref org-tree-slide origami ox-reveal paredit rainbow-mode restclient rg
          vertico windresize writegood-mode writeroom-mode zenburn-theme))
