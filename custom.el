...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 180 :width normal :foundry "nil" :family "Operator Mono Ssm AB"))))
 '(fixed-pitch ((t (:family "Operator Mono Ssm AB"))))
 '(org-drawer ((t (:inherit font-lock-comment-delimiter-face :weight normal))))
 '(org-special-keyword ((t (:inherit font-lock-comment-delimiter-face :weight normal)))))
