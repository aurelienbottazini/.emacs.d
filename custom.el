(custom-set-variables
 ...
 '(package-selected-packages
   '(cape cider citre coffee-mode context-coloring copilot corfu deadgrep deft diminish dired-rsync
          drag-stuff dumb-jump elm-mode emamux embark-consult emmet-mode envrc evil-commentary
          evil-matchit evil-surround evil-visualstar exec-path-from-shell expand-region flycheck
          flymake-eslint forge fullframe general git-link go-mode highlight-blocks hyperbole iedit
          js2-mode json-mode key-chord lsp-ivy lsp-treemacs lsp-ui marginalia multiple-cursors
          ob-clojurescript ob-mermaid orderless org-download org-ref org-tree-slide origami
          ox-reveal paredit prettier-js rainbow-mode restclient rg robe rspec-mode ruby-end
          ruby-interpolation rust-mode sass-mode scss-mode sqlite3 vertico web-mode windresize
          writegood-mode writeroom-mode yaml-mode yasnippet))
...
(custom-set-faces
 ...
 '(org-block ((t (:inherit fixed-pitch :extend t :background "#eee"))))
 ...
 '(org-level-3 ((t (:inherit outline-3 :extend nil :weight bold :height 1.2))))
 ...
 '(variable-pitch ((t (:family "Heinemann Special" :height 140)))))
