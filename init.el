...
(use-package zenburn-theme
 ...
 (diary ((t (:foreground "#cc9393"))))
 (diff-hl-delete ((t (:foreground "#ecb3b3"))))
 (diff-indicator-removed ((t (:foreground "#dca3a3" :background "#7c4343"))))
 (dired-flagged ((t (:foreground "#ecb3b3"))))
 (epa-mark ((t (:foreground "#ecb3b3"))))
 (epa-string ((t (:foreground "#94BFF3"))))
 (error ((t (:background "#6c3333" :foreground "#ecb3b3"))))
 (evil-ex-info ((t (:foreground "#ecb3b3"))))
 (evil-ex-substitute-replacement ((t (:foreground "#ecb3b3" :underline t))))
 (fill-column-indicator ((t (:foreground "#6f6f6f"))))
 (helm-prefarg ((t (:foreground "#ecb3b3"))))
 (homoglyph ((t (:foreground "#ac7373"))))
 ...
 (org-date-selected ((t (:background "#cc9393" :foreground "#2b2b2b"))))
 (transient-amaranth ((t (:foreground "#ecb3b3"))))
 (transient-red ((t (:foreground "#cc9393"))))
 (transient-blue ((t (:foreground "#94bff3"))))
 (table-cell ((t (:background "#94bff3" :foreground "#2b2b2b"))))
 (tty-menu-disabled-face ((t (:background "#cc9393" :foreground "#2b2b2b"))))
 (tty-menu-enabled-face ((t (:background "#94bff3" :foreground "#2b2b2b"))))
 (tty-menu-selected-face ((t (:background "#f0dfaf" :foreground "#2b2b2b"))))
 (table-cell ((t (:background "#94bff3" :foreground "#2b2b2b"))))
 (transient-disabled-suffix ((t (:background "#cc9393" :foreground "#2b2b2b"))))
 (nobreak-hyphen ((t (:foreground "#bc8383"))))
 (org-headline-todo ((t (:foreground "#bc8383"))))
 ...
 (widget-button-pressed ((t (:foreground "#bc8383"))))
 (widget-single-line-field ((t (:background "#afd8af" :foreground "#2b2b2b"))))
 :config
